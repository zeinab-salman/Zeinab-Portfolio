...
export default function ProjectCard({ img, projectTitle, description, href }) {
  return (
    <motion.div
      className="project-card flex flex-col justify-center items-start gap-4 glass-effect px-5 pt-5 pb-16 w-[32%] transition-all duration-300 transform hover:scale-105 "
